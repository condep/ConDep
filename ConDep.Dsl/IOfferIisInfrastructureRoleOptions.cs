namespace ConDep.Dsl
{
    public interface IOfferIisInfrastructureRoleOptions
    {
        ...
        /// </summary>
        /// <returns></returns>
        IOfferIisInfrastructureRoleOptions HttpRedirect();
        ...
        /// </summary>
        /// <returns></returns>
        IOfferIisInfrastructureRoleOptions DavPublishing();
        ...
        /// </summary>
        /// <returns></returns>
        IOfferIisInfrastructureRoleOptions Asp();
        ...
        /// </summary>
        /// <returns></returns>
        IOfferIisInfrastructureRoleOptions Cgi();
        ...
        /// </summary>
        /// <returns></returns>
        IOfferIisInfrastructureRoleOptions ServerSideIncludes();

        /// <summary>
        /// Logging Tools provides infrastructure to manage Web server logs and automate common logging tasks.
        /// </summary>
        /// <returns></returns>
        IOfferIisInfrastructureRoleOptions LoggingTools();
        ...
        /// </summary>
        /// <returns></returns>
        IOfferIisInfrastructureRoleOptions Tracing();
        ...
        /// </summary>
        /// <returns></returns>
        IOfferIisInfrastructureRoleOptions CustomLogging();
        ...
        /// </summary>
        /// <returns></returns>
        IOfferIisInfrastructureRoleOptions OdbcLogging();
        ...
        /// </summary>
        /// <returns></returns>
        IOfferIisInfrastructureRoleOptions BasicAuth();
        ...
        /// </summary>
        /// <returns></returns>
        IOfferIisInfrastructureRoleOptions WindowsAuth();
        ...
        /// </summary>
        /// <returns></returns>
        IOfferIisInfrastructureRoleOptions DigestAuth();
        ...
        /// </summary>
        /// <returns></returns>
        IOfferIisInfrastructureRoleOptions ActiveDirectoryClientCertMappingAuth();
        ...
        /// </summary>
        /// <returns></returns>
        IOfferIisInfrastructureRoleOptions IisClientCertMappingAuth();
        ...
        /// </summary>
        /// <returns></returns>
        IOfferIisInfrastructureRoleOptions UrlAuth();
        ...
        /// </summary>
        /// <returns></returns>
        IOfferIisInfrastructureRoleOptions IpSecurity();
        ...
        /// </summary>
        /// <returns></returns>
        IOfferIisInfrastructureRoleOptions DynamicContentCompression();
        ...
        /// </summary>
        /// <returns></returns>
        IOfferIisInfrastructureRoleOptions MngmntScriptsAndTools();
        ...
        /// </summary>
        /// <returns></returns>
        IOfferIisInfrastructureRoleOptions MgmtService();
    }
}