...
{
    public class WebDeploySync
    {
        private readonly WebDeployDefinition _definition;
        private readonly Action<object, WebDeployMessageEventArgs> _output;
        private readonly Action<object, WebDeployMessageEventArgs> _outputError;

        public WebDeploySync(WebDeployDefinition webDeployDefinition, Action<object, WebDeployMessageEventArgs> output, Action<object, WebDeployMessageEventArgs> outputError)
        {
